...
// Has not been updated for our tests yet
public class PasswordEvaluationTestingAutomation {
	...
	private static void displayPasswordEvaluation() {
		...
		if (PasswordEvaluator.PfoundLowerCase)
		...
		if (PasswordEvaluator.PfoundLongEnough)
			System.out.println("At least 6 characters - Satisfied");
		else
			System.out.println("At least 6 characters - Not Satisfied");
	}
}
